...
public class memberProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.hide();
        ImageButton setting_btn = (ImageButton) findViewById(R.id.settingbtn);
        ...
        setting_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(memberProfile.this,
                        memberSetting.class);
    ...
    private void uploadImageToFirebase(Uri imageUri) {
        ...
        fileRef.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(memberProfile.this, "Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
}